...
*/
    ...
    public static RequestSpecification requestShopSpecification() throws IOException {
        return new RequestSpecBuilder().setBaseUri("http://restapi.adequateshop.com/").setContentType(ContentType.JSON).build();
